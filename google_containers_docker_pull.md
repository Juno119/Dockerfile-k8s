...
[版本参考地址](https://kubernetes.io/docs/reference/setup-tools/kubeadm/kubeadm-init/#running-kubeadm-without-an-internet-connection)

# kubernetes master 节点 必需容器
```shell 


docker pull jingjingxyk/dockerfile-k8s:kube-apiserver
docker tag jingjingxyk/dockerfile-k8s:kube-apiserver k8s.gcr.io/kube-apiserver-amd64:v1.11.3

docker pull jingjingxyk/dockerfile-k8s:kube-controller-manager
docker tag jingjingxyk/dockerfile-k8s:kube-controller-manager k8s.gcr.io/kube-controller-manager-amd64:v1.11.3


docker pull jingjingxyk/dockerfile-k8s:kube-proxy
docker tag jingjingxyk/dockerfile-k8s:kube-proxy k8s.gcr.io/kube-proxy-amd64:v1.11.3

docker pull jingjingxyk/dockerfile-k8s:kube-scheduler
docker tag jingjingxyk/dockerfile-k8s:kube-scheduler k8s.gcr.io/kube-scheduler-amd64:v1.11.3
